 ...
 * TODO 断点续传自定义View
 * 
 * 引自：http://rensanning.iteye.com/blog/2248760
 * 
 */
@Component(value = "byteRangeViewRender")
public final class ByteRangeViewRender extends AbstractView {
    ...
    @Override
    protected void renderMergedOutputModel(Map<String, Object> objectMap, HttpServletRequest request,
