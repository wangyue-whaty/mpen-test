...
class SmsSenderUtil {
    ...
    public String stringMD5(String input) throws Exception {
    ...
    protected String strToHash(String str) throws Exception {
    ...
    public String byteArrayToHex(byte[] byteArray) throws Exception{
    ...
    public JSONArray smsParamsToJSONArray(ArrayList<String> params) throws Exception{
    ...
    public SmsMultiSenderResult jsonToSmsMultiSenderResult(JSONObject json) throws Exception{
    ...
    public SmsStatusPullReplyResult jsonToSmsStatusPullReplyResult(JSONObject json) throws Exception{
    ...
    public SmsVoiceVerifyCodeSenderResult jsonToSmsVoiceVerifyCodeSenderResult(JSONObject json)throws Exception {
    ...
    public SmsVoicePromptSenderResult jsonToSmsVoicePromptSenderResult(JSONObject json) throws Exception{
